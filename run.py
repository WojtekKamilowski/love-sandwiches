...
def validate_data(values):
    ...
    return True
"""
update_worksheet before refactored into one function:
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplus for each time type.
...
def get_last_5_entries_sales():
    """
    Collects columns of data from sales worksheet, collecging
